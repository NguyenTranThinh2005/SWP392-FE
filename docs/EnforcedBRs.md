...
| **P1 - Series Proposal** | **BR-15** | Proposal Validation | [validation.ts](file:///d:/FPTU/SWP392/FE-nextjs/my-app/lib/validation.ts#L4-L23) | Sử dụng `seriesProposalSchema` (Zod) để kiểm tra độ dài tiêu đề ($\le 100$), tóm tắt ($200$–$2000$), loại bỏ yêu cầu tải lên 5 ảnh và yêu cầu tệp tin nguồn ZIP khi gửi duyệt. |
